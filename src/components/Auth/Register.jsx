...
function Register(){
    ...
    const register = async ()=>{
        if (name!='' && email!="" && password != "" && psc != '' && gender!='' && phone!='') {
            if (password==psc) {
                let data={
                    'name':name,
                    'email':email,
    ...
    return(
        <div className="d-flex justify-content-center align-items-center parentsRegister py-3">
            <div className="container-fluid row">
                <div className="col-lg-4 offset-lg-4 bg-white shadow p-3 rounded">
                    <div className="p-4">
                            ...
                            <div className="py-2">
                                <label className="py-2" htmlFor="">Phone</label>
                                <input type="text" name="phone" onChange={(e)=>setPhone(e.target.value)} className="form-control py-2" />
                            </div>

                            <div className="py-2">
                                <label className="py-2" htmlFor="">Gender</label>
